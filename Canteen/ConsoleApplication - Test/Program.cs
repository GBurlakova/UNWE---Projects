...
class Event : IComparable
{
    ...
    public override string ToString()
    {
        ...
        toString.Append(date.ToString("yyyy-MM-ddTHH:mm:ss") + " | " + title);
...
//Every class must be in separate file.
class Program
{
    ...
    private static bool ExecuteNextCommand()
    {
        ...
        switch (command[0])
        {
            case 'A': AddEvent(command);
                return true;
                break;
            case 'D': DeleteEvents(command);
                return true;
                break;
            case 'L': getListOfEvents(command);
                return true;
                break;
    ...
    private static void getListOfEvents(string command)
    {
